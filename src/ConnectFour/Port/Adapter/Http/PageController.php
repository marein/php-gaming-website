...
final class PageController extends AbstractController
{
    ...
    {
        return $this->render('@connect-four/lobby.html.twig');
    }

    public function gameAction(string $id): Response
    {
        return $this->render('@connect-four/game.html.twig', [
    ...
    public function historyAction(#[CurrentUser] ?User $user, Request $request): Response
    {
        ...
        if (!in_array($state, State::visibleCases(), true) || $stateQuery === State::All->value) {
            return $this->redirectToRoute('connect_four_history');
        }

        return $this->render('@connect-four/history.html.twig', [
            'state' => $state,
