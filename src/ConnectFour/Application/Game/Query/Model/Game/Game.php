...
final class Game
{
    ...
    {
        $this->redPlayerId = $playerJoined->startingPlayerId;
        $this->yellowPlayerId = $playerJoined->opponentPlayerId() === $playerJoined->startingPlayerId
            ? $playerJoined->joinedPlayerId()
            : $playerJoined->opponentPlayerId();
        $this->currentPlayerId = $playerJoined->startingPlayerId;
